...
#include <Windows.h>  // for WORD typedef
...
class CLayer : public CSegs {
 public:
  ...
  static const WORD STATE_FLG_COLD =
      0x0010;  // tracing which is viewed or layer which is static (no additions or modifications)
 ...
 public:  // Constructors and destructor
  ...
  void Display(CPegView* pView, CDC* pDC, bool bIdentifyTrap);
