...
void opengl::Frustum(double dUMin, double dUMax, double dVMin, double dVMax, double dNearClipDistance,
                     double dFarClipDistance) {
  GLint nMatrixMode;
...
void opengl::Ortho(double dUMin, double dUMax, double dVMin, double dVMax, double dNearClipDistance,
                   double dFarClipDistance) {
  GLint nMatrixMode;
  glGetIntegerv(GL_MATRIX_MODE, &nMatrixMode);
  glMatrixMode(GL_PROJECTION);
