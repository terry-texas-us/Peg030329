...
typedef bool(EXECCMDFN)(struct _TOPICINFO* pTopic, LPSTR pszResultString, UINT uiResultSize, UINT uiNargs,
                        LPSTR* ppArgs);
...
bool ParseCmd(LPSTR* ppszCmdLine, PTOPICINFO pTopic, LPSTR pszError, UINT uiErrorSize, PPOP pOpTable, UINT uiNops,
              LPSTR pArgBuf);
