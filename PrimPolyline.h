...
class CPrimPolyline : public CPrim {
 ...
 public:  // Methods - absolute virtuals
  ...
  bool Is(CPrim::Type type) const { return type == CPrim::Type::Polyline; }
...
#else
#define PRIM_POLYLINE_CLOSED \
  0x0200  // This flag value must match AD_LWPLINE_IS_CLOSED (I don't have access to the 2003 ODAheaders, so this may be wrong)
