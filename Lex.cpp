...
LPSTR lex::ScanForChar(char c,        // The character to look for.
...
LPSTR lex::SkipWhiteSpace(LPSTR pszString)  // Pointer to the current buffer position.
{
...
LPSTR lex::ScanForString(LPSTR* ppStr,   // Pointer to the current scan pointer.
