...
class CPrim : public CObject {
 ...
 public:  // Constructors and destructor
  ...
  explicit CPrim(PENCOLOR color, PENSTYLE style) noexcept : m_nPenColor(color), m_nPenStyle(style) {}
 ...
 public:  // Methods - absolute virtuals
  ...
  virtual void Display(CPegView* view, CDC* pDC) const = 0;
  ...
  virtual bool IsInView(CPegView* view) const = 0;
  virtual bool IsPtACtrlPt(CPegView* view, const CPnt4&) const = 0;
  virtual void Read(CFile&) = 0;
  virtual CPnt SelAtCtrlPt(CPegView* view, const CPnt4&) const = 0;
  virtual bool SelUsingLine(CPegView* view, const CLine& ln, CPnts& ptsInt) = 0;
  virtual bool SelUsingPoint(CPegView* view, const CPnt4&, double, CPnt&) = 0;
  virtual bool SelUsingRect(CPegView* view, const CPnt&, const CPnt&) = 0;
...
inline bool Prim_IsByBlockPenStyle(const TCHAR* sName) { return (_tcsicmp(sName, _T("ByBlock")) == 0 ? true : false); }
inline bool Prim_IsByLayerPenStyle(const TCHAR* sName) { return (_tcsicmp(sName, _T("ByLayer")) == 0 ? true : false); }
