...
{
	return CPnt4(std::max(ptA.m_d[0], ptB.m_d[0]), std::max(ptA.m_d[1], ptB.m_d[1]), std::max(ptA.m_d[2], ptB.m_d[2]), std::max(ptA.m_d[3], ptB.m_d[3]));
}
CPnt4 Min(const CPnt4& ptA, const CPnt4& ptB)
{
	return CPnt4(std::min(ptA.m_d[0], ptB.m_d[0]), std::min(ptA.m_d[1], ptB.m_d[1]), std::min(ptA.m_d[2], ptB.m_d[2]), std::min(ptA.m_d[3], ptB.m_d[3]));
}
