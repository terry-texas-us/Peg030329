...
{
	return CVec4(std::max(vA.m_d[0], vB.m_d[0]), std::max(vA.m_d[1], vB.m_d[1]), std::max(vA.m_d[2], vB.m_d[2]), std::max(vA.m_d[3], vB.m_d[3]));
}
CVec4 Min(const CVec4& vA, const CVec4& vB)
{
	return CVec4(std::min(vA.m_d[0], vB.m_d[0]), std::min(vA.m_d[1], vB.m_d[1]), std::min(vA.m_d[2], vB.m_d[2]), std::min(vA.m_d[3], vB.m_d[3]));
}